				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != MainActivity.RESULT_OK) {
							...
							NotificationManager nManager = (NotificationManager) mApplicationContext.getSystemService(Context.NOTIFICATION_SERVICE);
							
							nManager.notify(MY_NOTIFICATION_ID, notificationBuilder.build());
